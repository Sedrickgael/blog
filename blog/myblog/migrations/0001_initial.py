# Generated by Django 2.2.7 on 2019-11-14 00:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='categorie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article_sous_categorie', to='myblog.Categorie'),
        ),
        migrations.AddField(
            model_name='article',
            name='tague',
            field=models.ManyToManyField(related_name='article_tag', to='myblog.Tague'),
        ),
    ]
